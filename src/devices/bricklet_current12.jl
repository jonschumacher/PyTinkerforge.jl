...
export BrickletCurrent12CurrentCallbackThreshold
struct BrickletCurrent12CurrentCallbackThreshold
    option::Char
    min::Integer
    max::Integer
end

export BrickletCurrent12AnalogValueCallbackThreshold
struct BrickletCurrent12AnalogValueCallbackThreshold
    option::Char
    min::Integer
    max::Integer
end

export BrickletCurrent12Identity
struct BrickletCurrent12Identity
    uid::String
...
export BrickletCurrent12
"""
Measures AC/DC current between -12.5A and +12.5A
"""
mutable struct BrickletCurrent12 <: TinkerforgeDevice
    ipcon::IPConnection
    ...
    """
    function BrickletCurrent12(uid::String, ipcon::IPConnection)
        package = pyimport("tinkerforge.bricklet_current12")
        deviceInternal = package.BrickletCurrent12(uid, ipcon.ipconInternal)
...
"""
function get_current(device::BrickletCurrent12)
...
Bricklet.
"""
function calibrate(device::BrickletCurrent12)
...
"""
function is_over_current(device::BrickletCurrent12)
...
"""
function get_analog_value(device::BrickletCurrent12)
...
the last triggering.
"""
function set_current_callback_period(device::BrickletCurrent12, period)
...
"""
function get_current_callback_period(device::BrickletCurrent12)
...
"""
function set_analog_value_callback_period(device::BrickletCurrent12, period)
...
"""
function get_analog_value_callback_period(device::BrickletCurrent12)
...
"""
function set_current_callback_threshold(device::BrickletCurrent12, option, min, max)
...
"""
function get_current_callback_threshold(device::BrickletCurrent12)
...
"""
function set_analog_value_callback_threshold(device::BrickletCurrent12, option, min, max)
...
"""
function get_analog_value_callback_threshold(device::BrickletCurrent12)
...
keep being reached.
"""
function set_debounce_period(device::BrickletCurrent12, debounce)
...
"""
function get_debounce_period(device::BrickletCurrent12)
...
"""
function get_identity(device::BrickletCurrent12)
...
"""
function register_callback(device::BrickletCurrent12, callback_id, function_)
