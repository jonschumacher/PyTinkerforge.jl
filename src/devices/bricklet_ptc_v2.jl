...
export BrickletPTCV2TemperatureCallbackConfiguration
struct BrickletPTCV2TemperatureCallbackConfiguration
    period::Integer
...
export BrickletPTCV2ResistanceCallbackConfiguration
struct BrickletPTCV2ResistanceCallbackConfiguration
    period::Integer
    value_has_to_change::Bool
    option::Char
    min::Integer
...
export BrickletPTCV2MovingAverageConfiguration
struct BrickletPTCV2MovingAverageConfiguration
    moving_average_length_resistance::Integer
    moving_average_length_temperature::Integer
end

export BrickletPTCV2SPITFPErrorCount
struct BrickletPTCV2SPITFPErrorCount
...
export BrickletPTCV2Identity
struct BrickletPTCV2Identity
    uid::String
...
export BrickletPTCV2
"""
Reads temperatures from Pt100 und Pt1000 sensors
"""
mutable struct BrickletPTCV2 <: TinkerforgeDevice
    ipcon::IPConnection
    ...
    """
    function BrickletPTCV2(uid::String, ipcon::IPConnection)
        package = pyimport("tinkerforge.bricklet_ptc_v2")
        deviceInternal = package.BrickletPTCV2(uid, ipcon.ipconInternal)
...
"""
function get_temperature(device::BrickletPTCV2)
...
"""
function set_temperature_callback_configuration(device::BrickletPTCV2, period, value_has_to_change, option, min, max)
...
"""
function get_temperature_callback_configuration(device::BrickletPTCV2)
...
"""
function get_resistance(device::BrickletPTCV2)
...
If the option is set to 'x' (threshold turned off) the callback is triggered with the fixed period.
"""
function set_resistance_callback_configuration(device::BrickletPTCV2, period, value_has_to_change, option, min, max)
...
"""
function get_resistance_callback_configuration(device::BrickletPTCV2)
...
attenuated by 82dB.
"""
function set_noise_rejection_filter(device::BrickletPTCV2, filter)
...
"""
function get_noise_rejection_filter(device::BrickletPTCV2)
...
"""
function is_sensor_connected(device::BrickletPTCV2)
...
"""
function set_wire_mode(device::BrickletPTCV2, mode)
...
"""
function get_wire_mode(device::BrickletPTCV2)
...
"""
function set_moving_average_configuration(device::BrickletPTCV2, moving_average_length_resistance, moving_average_length_temperature)
...
"""
function get_moving_average_configuration(device::BrickletPTCV2)
...
"""
function set_sensor_connected_callback_configuration(device::BrickletPTCV2, enabled)
...
"""
function get_sensor_connected_callback_configuration(device::BrickletPTCV2)
...
"""
function get_spitfp_error_count(device::BrickletPTCV2)
...
"""
function set_bootloader_mode(device::BrickletPTCV2, mode)
...
"""
function get_bootloader_mode(device::BrickletPTCV2)
...
necessary to call it in a normal user program.
"""
function set_write_firmware_pointer(device::BrickletPTCV2, pointer)
...
necessary to call it in a normal user program.
"""
function write_firmware(device::BrickletPTCV2, data)
...
"""
function set_status_led_config(device::BrickletPTCV2, config)
...
"""
function get_status_led_config(device::BrickletPTCV2)
...
temperature changes.
"""
function get_chip_temperature(device::BrickletPTCV2)
...
undefined behavior!
"""
function reset(device::BrickletPTCV2)
...
"""
function write_uid(device::BrickletPTCV2, uid)
...
"""
function read_uid(device::BrickletPTCV2)
...
"""
function get_identity(device::BrickletPTCV2)
...
"""
function register_callback(device::BrickletPTCV2, callback_id, function_)
