...
export BrickSilentStepperSpeedRamping
struct BrickSilentStepperSpeedRamping
    acceleration::Integer
    deacceleration::Integer
end

export BrickSilentStepperStepConfiguration
struct BrickSilentStepperStepConfiguration
    step_resolution::Integer
    interpolation::Bool
end

export BrickSilentStepperBasicConfiguration
struct BrickSilentStepperBasicConfiguration
...
export BrickSilentStepperSpreadcycleConfiguration
struct BrickSilentStepperSpreadcycleConfiguration
...
export BrickSilentStepperStealthConfiguration
struct BrickSilentStepperStealthConfiguration
    enable_stealth::Bool
    amplitude::Integer
    gradient::Integer
...
export BrickSilentStepperCoolstepConfiguration
struct BrickSilentStepperCoolstepConfiguration
...
export BrickSilentStepperMiscConfiguration
struct BrickSilentStepperMiscConfiguration
    disable_short_to_ground_protection::Bool
    synchronize_phase_frequency::Integer
end

export BrickSilentStepperDriverStatus
struct BrickSilentStepperDriverStatus
    open_load::Integer
...
export BrickSilentStepperAllData
struct BrickSilentStepperAllData
...
export BrickSilentStepperSPITFPBaudrateConfig
struct BrickSilentStepperSPITFPBaudrateConfig
    enable_dynamic_baudrate::Bool
    minimum_dynamic_baudrate::Integer
end

export BrickSilentStepperSPITFPErrorCount
struct BrickSilentStepperSPITFPErrorCount
...
export BrickSilentStepperProtocol1BrickletName
struct BrickSilentStepperProtocol1BrickletName
    protocol_version::Integer
    firmware_version::Vector{Integer}
    name::String
end

export BrickSilentStepperIdentity
struct BrickSilentStepperIdentity
    uid::String
...
export BrickSilentStepper
"""
Silently drives one bipolar stepper motor with up to 46V and 1.6A per phase
"""
mutable struct BrickSilentStepper <: TinkerforgeDevice
    ipcon::IPConnection
    ...
    """
    function BrickSilentStepper(uid::String, ipcon::IPConnection)
        package = pyimport("tinkerforge.brick_silent_stepper")
        deviceInternal = package.BrickSilentStepper(uid, ipcon.ipconInternal)
...
:func:`Drive Backward`.
"""
function set_max_velocity(device::BrickSilentStepper, velocity)
...
"""
function get_max_velocity(device::BrickSilentStepper)
...
"""
function get_current_velocity(device::BrickSilentStepper)
...
"""
function set_speed_ramping(device::BrickSilentStepper, acceleration, deacceleration)
...
"""
function get_speed_ramping(device::BrickSilentStepper)
...
"""
function full_brake(device::BrickSilentStepper)
...
"""
function set_current_position(device::BrickSilentStepper, position)
...
"""
function get_current_position(device::BrickSilentStepper)
...
"""
function set_target_position(device::BrickSilentStepper, position)
...
"""
function get_target_position(device::BrickSilentStepper)
...
"""
function set_steps(device::BrickSilentStepper, steps)
...
"""
function get_steps(device::BrickSilentStepper)
...
it will return 1500.
"""
function get_remaining_steps(device::BrickSilentStepper)
...
interpolation off.
"""
function set_step_configuration(device::BrickSilentStepper, step_resolution, interpolation)
...
"""
function get_step_configuration(device::BrickSilentStepper)
...
"""
function drive_forward(device::BrickSilentStepper)
...
set by :func:`Set Max Velocity` and :func:`Set Speed Ramping` will be used.
"""
function drive_backward(device::BrickSilentStepper)
...
:func:`Set Speed Ramping`.
"""
function stop(device::BrickSilentStepper)
...
"""
function get_stack_input_voltage(device::BrickSilentStepper)
...
.. warning::
 ...
 stack voltage
"""
function get_external_input_voltage(device::BrickSilentStepper)
...
"""
function set_motor_current(device::BrickSilentStepper, current)
...
"""
function get_motor_current(device::BrickSilentStepper)
...
"""
function enable(device::BrickSilentStepper)
...
"""
function disable(device::BrickSilentStepper)
...
"""
function is_enabled(device::BrickSilentStepper)
...
"""
function set_basic_configuration(device::BrickSilentStepper, standstill_current, motor_run_current, standstill_delay_time, power_down_time, stealth_threshold, coolstep_threshold, classic_threshold, high_velocity_chopper_mode)
...
"""
function get_basic_configuration(device::BrickSilentStepper)
...
"""
function set_spreadcycle_configuration(device::BrickSilentStepper, slow_decay_duration, enable_random_slow_decay, fast_decay_duration, hysteresis_start_value, hysteresis_end_value, sine_wave_offset, chopper_mode, comparator_blank_time, fast_decay_without_comparator)
...
Returns the configuration as set by :func:`Set Basic Configuration`.
"""
function get_spreadcycle_configuration(device::BrickSilentStepper)
...
"""
function set_stealth_configuration(device::BrickSilentStepper, enable_stealth, amplitude, gradient, enable_autoscale, force_symmetric, freewheel_mode)
...
"""
function get_stealth_configuration(device::BrickSilentStepper)
...
"""
function set_coolstep_configuration(device::BrickSilentStepper, minimum_stallguard_value, maximum_stallguard_value, current_up_step_width, current_down_step_width, minimum_current, stallguard_threshold_value, stallguard_mode)
...
"""
function get_coolstep_configuration(device::BrickSilentStepper)
...
* Synchronize Phase Frequency: With this parameter you can synchronize the chopper for both phases
  ...
  f_clk is 12.8MHz.
"""
function set_misc_configuration(device::BrickSilentStepper, disable_short_to_ground_protection, synchronize_phase_frequency)
...
"""
function get_misc_configuration(device::BrickSilentStepper)
...
"""
function get_driver_status(device::BrickSilentStepper)
...
"""
function set_minimum_voltage(device::BrickSilentStepper, voltage)
...
"""
function get_minimum_voltage(device::BrickSilentStepper)
...
"""
function set_time_base(device::BrickSilentStepper, time_base)
...
"""
function get_time_base(device::BrickSilentStepper)
...
"""
function get_all_data(device::BrickSilentStepper)
...
"""
function set_all_data_period(device::BrickSilentStepper, period)
...
"""
function get_all_data_period(device::BrickSilentStepper)
...
"""
function set_spitfp_baudrate_config(device::BrickSilentStepper, enable_dynamic_baudrate, minimum_dynamic_baudrate)
...
.. versionadded:: 2.0.4\$nbsp;(Firmware)
"""
function get_spitfp_baudrate_config(device::BrickSilentStepper)
...
"""
function get_send_timeout_count(device::BrickSilentStepper, communication_method)
...
the baudrate.
"""
function set_spitfp_baudrate(device::BrickSilentStepper, bricklet_port, baudrate)
...
"""
function get_spitfp_baudrate(device::BrickSilentStepper, bricklet_port)
...
"""
function get_spitfp_error_count(device::BrickSilentStepper, bricklet_port)
...
"""
function enable_status_led(device::BrickSilentStepper)
...
The default state is enabled.
"""
function disable_status_led(device::BrickSilentStepper)
...
"""
function is_status_led_enabled(device::BrickSilentStepper)
...
plugins.
"""
function get_protocol1_bricklet_name(device::BrickSilentStepper, port)
...
temperature changes.
"""
function get_chip_temperature(device::BrickSilentStepper)
...
undefined behavior!
"""
function reset(device::BrickSilentStepper)
...
"""
function write_bricklet_plugin(device::BrickSilentStepper, port, offset, chunk)
...
necessary to call it in a normal user program.
"""
function read_bricklet_plugin(device::BrickSilentStepper, port, offset)
...
"""
function get_identity(device::BrickSilentStepper)
...
"""
function register_callback(device::BrickSilentStepper, callback_id, function_)
