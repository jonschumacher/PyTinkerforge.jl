...
export BrickletLinearPotiPositionCallbackThreshold
struct BrickletLinearPotiPositionCallbackThreshold
    option::Char
    min::Integer
    max::Integer
end

export BrickletLinearPotiAnalogValueCallbackThreshold
struct BrickletLinearPotiAnalogValueCallbackThreshold
    option::Char
    min::Integer
    max::Integer
end

export BrickletLinearPotiIdentity
struct BrickletLinearPotiIdentity
    uid::String
...
export BrickletLinearPoti
"""
59mm linear potentiometer
"""
mutable struct BrickletLinearPoti <: TinkerforgeDevice
    ipcon::IPConnection
    ...
    """
    function BrickletLinearPoti(uid::String, ipcon::IPConnection)
        package = pyimport("tinkerforge.bricklet_linear_poti")
        deviceInternal = package.BrickletLinearPoti(uid, ipcon.ipconInternal)
...
"""
function get_position(device::BrickletLinearPoti)
...
"""
function get_analog_value(device::BrickletLinearPoti)
...
"""
function set_position_callback_period(device::BrickletLinearPoti, period)
...
"""
function get_position_callback_period(device::BrickletLinearPoti)
...
"""
function set_analog_value_callback_period(device::BrickletLinearPoti, period)
...
"""
function get_analog_value_callback_period(device::BrickletLinearPoti)
...
"""
function set_position_callback_threshold(device::BrickletLinearPoti, option, min, max)
...
"""
function get_position_callback_threshold(device::BrickletLinearPoti)
...
"""
function set_analog_value_callback_threshold(device::BrickletLinearPoti, option, min, max)
...
"""
function get_analog_value_callback_threshold(device::BrickletLinearPoti)
...
keep being reached.
"""
function set_debounce_period(device::BrickletLinearPoti, debounce)
...
"""
function get_debounce_period(device::BrickletLinearPoti)
...
"""
function get_identity(device::BrickletLinearPoti)
...
"""
function register_callback(device::BrickletLinearPoti, callback_id, function_)
